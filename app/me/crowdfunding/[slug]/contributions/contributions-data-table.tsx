      ...
      <div className='flex items-center gap-2'>
        <div className='relative max-w-sm flex-1'>
          ...
          <Input
            ...
            className='focus-visible:border-primary border-[#2B2B2B] bg-[#101010] pl-9 text-white placeholder:text-[#919191]'
          />
        </div>
      </div>

      {/* Table */}
      <div className='rounded-lg border border-[#2B2B2B] bg-[#101010]'>
        <Table>
          <TableHeader>
              ...
              <TableRow>
                ...
                >
                  <div className='flex flex-col items-center gap-2'>
                    <p className='text-[#919191]'>No contributions yet</p>
